...
{
    public override int character_Code { get => 402; }
    public override float HP_Max { get => 100; }
    public override float Speed { get => 1; }
    public override float atkDamage { get => 1; }
    public override float ultimate_Skill_Need { get => 100; }
    public override float ultimate_Skill_Start { get => 10; }
    public override List<string> special_Tags{ get => new List<string>() { "Test" }; }
    ...
    public override List<int> skill_Index { get => new List<int>() { 403 };}
